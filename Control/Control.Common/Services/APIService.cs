namespace Control.Common.Services
{
    ...
    string accessToken)
        ...
        //GET USER BY EMAIL consulta el usuario desdel api
        ...
        //PUT USER FROM APP MOVIL, este metodo actualiza el usuario desde app movil sin ID
        public async Task<Response> PutAsync<T>(
            string urlBase,
            string servicePrefix,
            string controller,
        ...
        //CHANGE PASSWORD FROM APP, este metodo permite el cambio del password desde la app movil
